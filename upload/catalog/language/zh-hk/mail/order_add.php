...
// Text
$_['text_subject']          = '%s - 訂單號 %s';
$_['text_greeting']         = '感謝您在 %s 網站購物，您的訂單已提交成功！我們將在確認您的付款後儘快處理您的訂單。';
$_['text_link']             = '請單擊以下連結查看您的訂單：';
...
$_['text_shipping_address'] = '配運地址';
$_['text_products']         = '商品列表';
$_['text_product']          = '商品';
$_['text_model']            = '型號';
$_['text_quantity']         = '數量';
$_['text_price']            = '金額';
$_['text_order_total']      = '訂單合計';
$_['text_total']            = '總計';
$_['text_download']         = '確認付款後您將通過以下連結下載商品';
$_['text_comment']          = '訂單留言';
