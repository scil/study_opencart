...
class __TwigTemplate_8a75de6c66395d96e95c56a7c40c364faaddcc7c272525981d602f532ac9b780 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        if (($context["tax_rates"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tax_rate"]) {
                ...
                // line 75
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["tax_rate"], "tax_rate_id", [], "any", false, false, false, 75), ($context["selected"] ?? null))) {
                    // line 76
                    echo "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "tax_rate_id", [], "any", false, false, false, 76);
                ...
                echo "</td>
                  <td class=\"text-left\">";
                // line 80
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "name", [], "any", false, false, false, 80);
                echo "</td>
                  <td class=\"text-right\">";
                // line 81
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "rate", [], "any", false, false, false, 81);
                echo "</td>
                  <td class=\"text-left\">";
                // line 82
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "type", [], "any", false, false, false, 82);
                echo "</td>
                  <td class=\"text-left\">";
                // line 83
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "geo_zone", [], "any", false, false, false, 83);
                echo "</td>
                  <td class=\"text-left\">";
                // line 84
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "date_added", [], "any", false, false, false, 84);
                echo "</td>
                  <td class=\"text-left\">";
                // line 85
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "date_modified", [], "any", false, false, false, 85);
                echo "</td>
                  <td class=\"text-right\"><a href=\"";
                // line 86
                echo twig_get_attribute($this->env, $this->source, $context["tax_rate"], "edit", [], "any", false, false, false, 86);
                echo "\" data-toggle=\"tooltip\" title=\"";
...
";
    ...
    {
        return new Source("", "localisation/tax_rate_list.twig", "");
    }
}
